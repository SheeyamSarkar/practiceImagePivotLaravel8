...
<section class="sidebar">
        <ul>
            ...
            <li class="sideLi">
                <button type="button" data-target="expandSidebar10" data-bs-toggle="tooltip" data-bs-placement="right"
                    title="Product">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none" viewBox="0 0 32 32" class='sideMenuIcon'><path fill="#828282" d="M25.333 8.667h-4V7.333a4 4 0 00-4-4h-2.666a4 4 0 00-4 4v1.334h-4a4 4 0 00-4 4v12a4 4 0 004 4h18.666a4 4 0 004-4v-12a4 4 0 00-4-4zm-12-1.334A1.334 1.334 0 0114.667 6h2.666a1.333 1.333 0 011.334 1.333v1.334h-5.334V7.333zm13.334 17.334A1.333 1.333 0 0125.333 26H6.667a1.334 1.334 0 01-1.334-1.333v-7.334A28.945 28.945 0 0016 19.373a29 29 0 0010.667-2.04v7.334zm0-10.254a26.52 26.52 0 01-21.334 0v-1.746a1.333 1.333 0 011.334-1.334h18.666a1.333 1.333 0 011.334 1.334v1.746z"/></svg>
                </button>             
            </li>
            ...
            <!-- <li class="sideLi">
                <button type="button" data-target="expandSidebar4" data-bs-toggle="tooltip" data-bs-placement="right"
                    title="Test">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none" viewBox="0 0 32 32" class='sideMenuIcon'><path fill="#828282" d="M25.333 8.667h-4V7.333a4 4 0 00-4-4h-2.666a4 4 0 00-4 4v1.334h-4a4 4 0 00-4 4v12a4 4 0 004 4h18.666a4 4 0 004-4v-12a4 4 0 00-4-4zm-12-1.334A1.334 1.334 0 0114.667 6h2.666a1.333 1.333 0 011.334 1.333v1.334h-5.334V7.333zm13.334 17.334A1.333 1.333 0 0125.333 26H6.667a1.334 1.334 0 01-1.334-1.333v-7.334A28.945 28.945 0 0016 19.373a29 29 0 0010.667-2.04v7.334zm0-10.254a26.52 26.52 0 01-21.334 0v-1.746a1.333 1.333 0 011.334-1.334h18.666a1.333 1.333 0 011.334 1.334v1.746z"/></svg>
                </button>             
            </li> -->
    ...
    <div class="extension-sidebar-wrapper">
        ...
        <!-- Expansion Sidebar -->
        <ul class="expansion-sidebar" id="expandSidebar4"> 
            <li class="multilevelMenu">
                <a href="#">Analysis Settings 
         ...
         <!-- Expansion Sidebar -->
         <ul class="expansion-sidebar" id="expandSidebar10">
            <li>
                <h3>Products</h3>
            </li>
            <li>
            ...
            <li>
                <a href="{{route('subcategories')}}">Sub Category</a>
            </li>  
            <li>
