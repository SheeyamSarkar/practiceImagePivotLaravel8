                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-4 form-input">
                                ...
                                <div class="custom-file big_image">
                                    <div class="col-md-8 offset-2">
                                        <input type="file" name="asset" class="custom-file-input dropify"
                                            data-errors-position="outside"
                                            data-allowed-file-extensions='["jpg","jpeg", "png"]' data-max-file-size="1.5M"
                            ...
                            <div class="col-4 form-input">
                                ...
                                <div class="custom-file big_image">
                                    <div class="col-md-8 offset-2">
                                        <input type="file" name="asset1" class="custom-file-input dropify"
                                            data-errors-position="outside"
                                            data-allowed-file-extensions='["jpg","jpeg", "png"]' data-max-file-size="1.5M"
                                            data-height="200" data-width="200">
                                    </div>
                            ...
                            <div class="col-4 form-input">
                                ...
                                <div class="custom-file big_image">
                                    <div class="col-md-8 offset-2">
                                        <input type="file" name="asset2" class="custom-file-input dropify"
                                            data-errors-position="outside"
                                            data-allowed-file-extensions='["jpg","jpeg", "png"]' data-max-file-size="1.5M"
                                            data-height="200" data-width="200">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 form-input">
                                ...
                                <div class="custom-file big_image1">
                                    <div class="col-md-8 offset-2">
                                        <input type="file" id="asset" name="image[][image]"
                            ...
                            <input type="hidden" id="hidden_image1_id" name="image[][id]" value="142">
                            {{-- <input type="hidden" id="hidden_image1_id" name="image[][image]" value="142"> --}}
                            <!-- Image 2 -->
                            <div class="col-4 form-input">
                                <label>Image2 (max:1.5 MB) (image2 size: 200x200)</label>
                                <div class="custom-file big_image2">
                                    <div class="col-md-8 offset-2">
                                        <input type="file" id="asset1" name="image[][image]"
                                            class="custom-file-input dropify" data-errors-position="outside"
                                            data-allowed-file-extensions='["jpg","jpeg", "png"]' data-max-file-size="1.5M"
                                            data-height="200" data-width="200">
                                    </div>
                            ...
                            <input type="hidden" id="hidden_image2_id" name="image[][id]" value="143">
                            {{-- <input type="hidden" id="hidden_image2_id" name="image[][image]" value="143"> --}}
                            <!-- Image 3 -->
                            <div class="col-4 form-input">
                                <label>Image3 (max:1.5 MB) (image3 size: 200x200)</label>
                                <div class="custom-file big_image3">
                                    <div class="col-md-8 offset-2">
                                        <input type="file" id="asset2" name="image[][image]"
                                            class="custom-file-input dropify" data-errors-position="outside"
                                            data-allowed-file-extensions='["jpg","jpeg", "png"]' data-max-file-size="1.5M"
                                            data-height="200" data-width="200">
                                    </div>
                            ...
                            <input type="hidden" id="hidden_image3_id" name="image[][id]" value="144">
                            {{-- <input type="hidden" id="hidden_image3_id" name="image[][image]" value="144"> --}}
